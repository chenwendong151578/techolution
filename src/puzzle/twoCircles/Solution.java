...
public class Solution {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(circles(new String[] {"0 5 9 0 9 7","0 15 11 0 20 16","26 0 10 39 0 23","37 0 5 30 0 11","41 0 0 28 0 13","4 0 15 0 3 4"})));		 
	}
